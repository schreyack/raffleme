...
const QUESTIONS = [
    ...
    {"question": "True or False: Santa Claus is based on Saint Nicholas.", "options": ["False", "True"], "correct": 0},
    ...
    {"question": "In what country did Christmas trees originate?", "options": ["Germany", "USA", "England", "France"], "correct": 2},
    {"question": "What does 'Xmas' stand for?", "options": ["Xylophone", "Christmas", "Xenon", "Xerox"], "correct": 2},
    ...
    {"question": "What is the highest-grossing Christmas movie of all time?", "options": ["Home Alone", "The Grinch", "Elf", "Die Hard"], "correct": 0},
    {"question": "Which country sends the most Christmas cards?", "options": ["USA", "UK", "Germany", "Japan"], "correct": 3},
    {"question": "What color are mistletoe berries?", "options": ["Red", "White", "Blue", "Yellow"], "correct": 1},
    {"question": "How many sides does a snowflake typically have?", "options": ["4", "6", "8", "10"], "correct": 3},
    {"question": "What is the name of Santa's wife?", "options": ["Mrs. Claus", "Mary Claus", "Clara Claus", "Anna Claus"], "correct": 3},
